...
plotpic2(bodysizelength1[bodysizearea1$Sex=="male",],bodysizelength1[bodysizearea1$Sex!="male",],tr,"Body length male vs female","males","females")
plotpic2(bodysizelength1[bodysizearea1$Sex!="male",],oocytesize1,tr,"Body length female vs oocytesize","females","oocytes")
plotpic2(bodysizelength1[bodysizearea1$Sex=="male",],spermsize1,tr,"Body length male vs spermsize","males","sperms")
plotpic2(bodysizelength1[bodysizearea1$Sex=="male",],primaryspermatocyte1,tr,"Body length male vs spermatocytesize","males","spermatocytes")
```
...
ggtree(tr)+geom_text(aes(label=label),hjust=-0.19,fontface="italic")+geom_point(subset=.(!isTip), 
           color="#1b9e77", size=sqrt(AncSperm/pi))+
           geom_point(subset=.(isTip),color="#7570b3", size=sqrt(spermsize/pi))+
           geom_text(subset=.(isTip),aes(label=round(spermsize,1)), hjust=1, vjust=-0.4, size=3)+
           geom_text(subset=.(!isTip),aes(label=round(AncSperm,1)), hjust=1.5, vjust=-0.4, size=3)+
